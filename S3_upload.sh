...
#Date: 11/01/2025
#Description: This script uploads logs to S3 bucket for Log Storage Cost Optimization.
#Version: 1.0

# Variables
JENKINS_HOME="/var/lib/jenkins"  # Replace with your Jenkins home directory
S3_BUCKET="s3://log-storage-cost-optimization"  # Replace with your S3 bucket name
